...
%     if nodeIndex == 1 & currentHour ~= hour(datetime('now'))
%         doPlots = true 
...
%            tic
           ...
           [mintsDailyRetimed,currentFileName,status] = ...
                    getMintsFileNameStrLive(period,dateIndex,rawDotMatsFolder,nodeID,nodeIndex,stringIn);
            if(status)
...
%                 toc
                ...
                if(doPlots)
                    ...
                    display("Plots Done for Node : " + nodeID  + " & Date: " + dateStr)                                             
